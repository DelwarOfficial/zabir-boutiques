...
function nowSql(date = /* @__PURE__ */ new Date()) {
...
export {
  ...
  getProps as b1,
  fetchStateSymbol as b2,
  AstroResponseHeadersReassigned as b3,
  responseSentSymbol as b4,
  getOriginPathname as b5,
  LocalsReassigned as b6,
  INTERNAL_RESPONSE_HEADERS as b7,
  escape as b8,
  isInternalPath as b9,
  collapseDuplicateTrailingSlashes as ba,
  hasFileExtension as bb,
  removeLeadingForwardSlash as bc,
  getRouteGenerator as bd,
  SessionStorageInitError as be,
  SessionStorageSaveError as bf,
  appSymbol as bg,
  ...
  renderHead as d,
  removeQueryString as e,
  FailedToFetchRemoteImageDimensions as f,
  IncompatibleDescriptorOptions as g,
  UnsupportedImageConversion as h,
  isRemotePath as i,
  joinPaths as j,
