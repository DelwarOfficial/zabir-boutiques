...
const __vite_import_meta_env__$1 = { "ASSETS_PREFIX": void 0, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://zabirboutiques.com", "SSR": true };
...
const __vite_import_meta_env__ = { "ASSETS_PREFIX": void 0, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://zabirboutiques.com", "SSR": true };
...
const serializedData = [{ "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "type": "page", "component": "_server-islands.astro", "params": ["name"], "segments": [[{ "content": "_server-islands", "dynamic": false, "spread": false }], [{ "content": "name", "dynamic": true, "spread": false }]], "pattern": "^\\/_server-islands\\/([^/]+?)\\/?$", "prerender": false, "isIndex": false, "fallbackRoutes": [], "route": "/_server-islands/[name]", "origin": "internal", "distURL": [], "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/_image", "component": "node_modules/@astrojs/cloudflare/dist/entrypoints/image-passthrough-endpoint.js", "params": [], "pathname": "/_image", "pattern": "^\\/_image\\/?$", "segments": [[{ "content": "_image", "dynamic": false, "spread": false }]], "type": "endpoint", "prerender": false, "fallbackRoutes": [], "distURL": [], "isIndex": false, "origin": "internal", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/checkout", "isIndex": false, "type": "endpoint", "pattern": "^\\/api\\/checkout\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "checkout", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/api/checkout.ts", "pathname": "/api/checkout", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/fraud/check", "isIndex": false, "type": "endpoint", "pattern": "^\\/api\\/fraud\\/check\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "fraud", "dynamic": false, "spread": false }], [{ "content": "check", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/api/fraud/check.ts", "pathname": "/api/fraud/check", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/orders/track", "isIndex": false, "type": "endpoint", "pattern": "^\\/api\\/orders\\/track\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "orders", "dynamic": false, "spread": false }], [{ "content": "track", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/api/orders/track.ts", "pathname": "/api/orders/track", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/payments/create", "isIndex": false, "type": "endpoint", "pattern": "^\\/api\\/payments\\/create\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "payments", "dynamic": false, "spread": false }], [{ "content": "create", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/api/payments/create.ts", "pathname": "/api/payments/create", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/payments/status/[id]", "isIndex": false, "type": "endpoint", "pattern": "^\\/api\\/payments\\/status\\/([^/]+?)\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "payments", "dynamic": false, "spread": false }], [{ "content": "status", "dynamic": false, "spread": false }], [{ "content": "id", "dynamic": true, "spread": false }]], "params": ["id"], "component": "src/pages/api/payments/status/[id].ts", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/payments/webhook", "isIndex": false, "type": "endpoint", "pattern": "^\\/api\\/payments\\/webhook\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "payments", "dynamic": false, "spread": false }], [{ "content": "webhook", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/api/payments/webhook.ts", "pathname": "/api/payments/webhook", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/search", "isIndex": false, "type": "endpoint", "pattern": "^\\/api\\/search\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "search", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/api/search.ts", "pathname": "/api/search", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/staff/ai/generate-product-content", "isIndex": false, "type": "endpoint", "pattern": "^\\/api\\/staff\\/ai\\/generate-product-content\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "ai", "dynamic": false, "spread": false }], [{ "content": "generate-product-content", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/api/staff/ai/generate-product-content.ts", "pathname": "/api/staff/ai/generate-product-content", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/staff/api-code", "isIndex": true, "type": "endpoint", "pattern": "^\\/api\\/staff\\/api-code\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "api-code", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/api/staff/api-code/index.ts", "pathname": "/api/staff/api-code", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/staff/api-keys", "isIndex": true, "type": "endpoint", "pattern": "^\\/api\\/staff\\/api-keys\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "api-keys", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/api/staff/api-keys/index.ts", "pathname": "/api/staff/api-keys", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/staff/coupons/[id]", "isIndex": false, "type": "endpoint", "pattern": "^\\/api\\/staff\\/coupons\\/([^/]+?)\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "coupons", "dynamic": false, "spread": false }], [{ "content": "id", "dynamic": true, "spread": false }]], "params": ["id"], "component": "src/pages/api/staff/coupons/[id].ts", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/staff/coupons", "isIndex": true, "type": "endpoint", "pattern": "^\\/api\\/staff\\/coupons\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "coupons", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/api/staff/coupons/index.ts", "pathname": "/api/staff/coupons", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/staff/fraud/override", "isIndex": false, "type": "endpoint", "pattern": "^\\/api\\/staff\\/fraud\\/override\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "fraud", "dynamic": false, "spread": false }], [{ "content": "override", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/api/staff/fraud/override.ts", "pathname": "/api/staff/fraud/override", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/staff/login", "isIndex": false, "type": "endpoint", "pattern": "^\\/api\\/staff\\/login\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "login", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/api/staff/login.ts", "pathname": "/api/staff/login", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/staff/logout", "isIndex": false, "type": "endpoint", "pattern": "^\\/api\\/staff\\/logout\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "logout", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/api/staff/logout.ts", "pathname": "/api/staff/logout", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/staff/orders/create", "isIndex": false, "type": "endpoint", "pattern": "^\\/api\\/staff\\/orders\\/create\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "orders", "dynamic": false, "spread": false }], [{ "content": "create", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/api/staff/orders/create.ts", "pathname": "/api/staff/orders/create", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/staff/orders/[id]/confirm", "isIndex": false, "type": "endpoint", "pattern": "^\\/api\\/staff\\/orders\\/([^/]+?)\\/confirm\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "orders", "dynamic": false, "spread": false }], [{ "content": "id", "dynamic": true, "spread": false }], [{ "content": "confirm", "dynamic": false, "spread": false }]], "params": ["id"], "component": "src/pages/api/staff/orders/[id]/confirm.ts", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/staff/orders/[id]/label", "isIndex": false, "type": "endpoint", "pattern": "^\\/api\\/staff\\/orders\\/([^/]+?)\\/label\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "orders", "dynamic": false, "spread": false }], [{ "content": "id", "dynamic": true, "spread": false }], [{ "content": "label", "dynamic": false, "spread": false }]], "params": ["id"], "component": "src/pages/api/staff/orders/[id]/label.ts", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/staff/returns/[id]/approve", "isIndex": false, "type": "endpoint", "pattern": "^\\/api\\/staff\\/returns\\/([^/]+?)\\/approve\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "returns", "dynamic": false, "spread": false }], [{ "content": "id", "dynamic": true, "spread": false }], [{ "content": "approve", "dynamic": false, "spread": false }]], "params": ["id"], "component": "src/pages/api/staff/returns/[id]/approve.ts", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/staff/returns/[id]/reject", "isIndex": false, "type": "endpoint", "pattern": "^\\/api\\/staff\\/returns\\/([^/]+?)\\/reject\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "returns", "dynamic": false, "spread": false }], [{ "content": "id", "dynamic": true, "spread": false }], [{ "content": "reject", "dynamic": false, "spread": false }]], "params": ["id"], "component": "src/pages/api/staff/returns/[id]/reject.ts", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/staff/returns", "isIndex": true, "type": "endpoint", "pattern": "^\\/api\\/staff\\/returns\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "returns", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/api/staff/returns/index.ts", "pathname": "/api/staff/returns", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/staff/step-up", "isIndex": false, "type": "endpoint", "pattern": "^\\/api\\/staff\\/step-up\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "step-up", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/api/staff/step-up.ts", "pathname": "/api/staff/step-up", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/staff/uploads", "isIndex": false, "type": "endpoint", "pattern": "^\\/api\\/staff\\/uploads\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "uploads", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/api/staff/uploads.ts", "pathname": "/api/staff/uploads", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/api/stock/[variantId]", "isIndex": false, "type": "endpoint", "pattern": "^\\/api\\/stock\\/([^/]+?)\\/?$", "segments": [[{ "content": "api", "dynamic": false, "spread": false }], [{ "content": "stock", "dynamic": false, "spread": false }], [{ "content": "variantId", "dynamic": true, "spread": false }]], "params": ["variantId"], "component": "src/pages/api/stock/[variantId].ts", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/checkout", "isIndex": false, "type": "page", "pattern": "^\\/checkout\\/?$", "segments": [[{ "content": "checkout", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/checkout.astro", "pathname": "/checkout", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/order-track", "isIndex": false, "type": "page", "pattern": "^\\/order-track\\/?$", "segments": [[{ "content": "order-track", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/order-track.astro", "pathname": "/order-track", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/orders", "isIndex": false, "type": "page", "pattern": "^\\/orders\\/?$", "segments": [[{ "content": "orders", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/orders.astro", "pathname": "/orders", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/api-code", "isIndex": true, "type": "page", "pattern": "^\\/staff\\/api-code\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "api-code", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/api-code/index.astro", "pathname": "/staff/api-code", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/audit", "isIndex": true, "type": "page", "pattern": "^\\/staff\\/audit\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "audit", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/audit/index.astro", "pathname": "/staff/audit", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/backups", "isIndex": true, "type": "page", "pattern": "^\\/staff\\/backups\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "backups", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/backups/index.astro", "pathname": "/staff/backups", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/coupons", "isIndex": true, "type": "page", "pattern": "^\\/staff\\/coupons\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "coupons", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/coupons/index.astro", "pathname": "/staff/coupons", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/fraud", "isIndex": true, "type": "page", "pattern": "^\\/staff\\/fraud\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "fraud", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/fraud/index.astro", "pathname": "/staff/fraud", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/inventory", "isIndex": true, "type": "page", "pattern": "^\\/staff\\/inventory\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "inventory", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/inventory/index.astro", "pathname": "/staff/inventory", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/login", "isIndex": false, "type": "page", "pattern": "^\\/staff\\/login\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "login", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/login.astro", "pathname": "/staff/login", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/media", "isIndex": true, "type": "page", "pattern": "^\\/staff\\/media\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "media", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/media/index.astro", "pathname": "/staff/media", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/media-admin", "isIndex": true, "type": "page", "pattern": "^\\/staff\\/media-admin\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "media-admin", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/media-admin/index.astro", "pathname": "/staff/media-admin", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/orders/[id]", "isIndex": false, "type": "page", "pattern": "^\\/staff\\/orders\\/([^/]+?)\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "orders", "dynamic": false, "spread": false }], [{ "content": "id", "dynamic": true, "spread": false }]], "params": ["id"], "component": "src/pages/staff/orders/[id].astro", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/orders", "isIndex": true, "type": "page", "pattern": "^\\/staff\\/orders\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "orders", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/orders/index.astro", "pathname": "/staff/orders", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/packing/courier", "isIndex": false, "type": "page", "pattern": "^\\/staff\\/packing\\/courier\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "packing", "dynamic": false, "spread": false }], [{ "content": "courier", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/packing/courier.astro", "pathname": "/staff/packing/courier", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/packing/packed", "isIndex": false, "type": "page", "pattern": "^\\/staff\\/packing\\/packed\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "packing", "dynamic": false, "spread": false }], [{ "content": "packed", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/packing/packed.astro", "pathname": "/staff/packing/packed", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/packing/slips", "isIndex": false, "type": "page", "pattern": "^\\/staff\\/packing\\/slips\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "packing", "dynamic": false, "spread": false }], [{ "content": "slips", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/packing/slips.astro", "pathname": "/staff/packing/slips", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/packing", "isIndex": true, "type": "page", "pattern": "^\\/staff\\/packing\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "packing", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/packing/index.astro", "pathname": "/staff/packing", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/products/[id]", "isIndex": false, "type": "page", "pattern": "^\\/staff\\/products\\/([^/]+?)\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "products", "dynamic": false, "spread": false }], [{ "content": "id", "dynamic": true, "spread": false }]], "params": ["id"], "component": "src/pages/staff/products/[id].astro", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/products", "isIndex": true, "type": "page", "pattern": "^\\/staff\\/products\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "products", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/products/index.astro", "pathname": "/staff/products", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/reports", "isIndex": true, "type": "page", "pattern": "^\\/staff\\/reports\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "reports", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/reports/index.astro", "pathname": "/staff/reports", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/roles", "isIndex": true, "type": "page", "pattern": "^\\/staff\\/roles\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "roles", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/roles/index.astro", "pathname": "/staff/roles", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/sales/instore", "isIndex": false, "type": "page", "pattern": "^\\/staff\\/sales\\/instore\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "sales", "dynamic": false, "spread": false }], [{ "content": "instore", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/sales/instore.astro", "pathname": "/staff/sales/instore", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/sales/new", "isIndex": false, "type": "page", "pattern": "^\\/staff\\/sales\\/new\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "sales", "dynamic": false, "spread": false }], [{ "content": "new", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/sales/new.astro", "pathname": "/staff/sales/new", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/sales/notes", "isIndex": false, "type": "page", "pattern": "^\\/staff\\/sales\\/notes\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "sales", "dynamic": false, "spread": false }], [{ "content": "notes", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/sales/notes.astro", "pathname": "/staff/sales/notes", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/sales/orders", "isIndex": false, "type": "page", "pattern": "^\\/staff\\/sales\\/orders\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "sales", "dynamic": false, "spread": false }], [{ "content": "orders", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/sales/orders.astro", "pathname": "/staff/sales/orders", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/sales/search", "isIndex": false, "type": "page", "pattern": "^\\/staff\\/sales\\/search\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "sales", "dynamic": false, "spread": false }], [{ "content": "search", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/sales/search.astro", "pathname": "/staff/sales/search", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/sales", "isIndex": true, "type": "page", "pattern": "^\\/staff\\/sales\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "sales", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/sales/index.astro", "pathname": "/staff/sales", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/settings", "isIndex": true, "type": "page", "pattern": "^\\/staff\\/settings\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "settings", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/settings/index.astro", "pathname": "/staff/settings", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/support/escalations", "isIndex": false, "type": "page", "pattern": "^\\/staff\\/support\\/escalations\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "support", "dynamic": false, "spread": false }], [{ "content": "escalations", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/support/escalations.astro", "pathname": "/staff/support/escalations", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/support/search", "isIndex": false, "type": "page", "pattern": "^\\/staff\\/support\\/search\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "support", "dynamic": false, "spread": false }], [{ "content": "search", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/support/search.astro", "pathname": "/staff/support/search", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/support", "isIndex": true, "type": "page", "pattern": "^\\/staff\\/support\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "support", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/support/index.astro", "pathname": "/staff/support", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff/users", "isIndex": true, "type": "page", "pattern": "^\\/staff\\/users\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }], [{ "content": "users", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/users/index.astro", "pathname": "/staff/users", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/staff", "isIndex": true, "type": "page", "pattern": "^\\/staff\\/?$", "segments": [[{ "content": "staff", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/staff/index.astro", "pathname": "/staff", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }];
serializedData.map(deserializeRouteInfo);
const _page0 = () => import("./image-passthrough-endpoint_Bil1upTj.mjs").then((n) => n.i);
const _page1 = () => import("./checkout_kPPoCdyZ.mjs");
const _page2 = () => import("./check_B_EMctBi.mjs");
const _page3 = () => import("./track_CV5TfOwA.mjs");
const _page4 = () => import("./create_DKTSp6Sn.mjs");
const _page5 = () => import("./_id__DtEo4TUx.mjs");
const _page6 = () => import("./webhook_DwICHqBE.mjs");
const _page7 = () => import("./search_CzZBN1Ic.mjs");
const _page8 = () => import("./generate-product-content_CRIbW4oc.mjs");
const _page9 = () => import("./index_DuPUWDZH.mjs");
const _page10 = () => import("./index_C72KvVBh.mjs");
const _page11 = () => import("./_id__D8oks4X1.mjs");
const _page12 = () => import("./index_BT7bzJl3.mjs");
const _page13 = () => import("./override_H1zyAkHr.mjs");
const _page14 = () => import("./login_BmVUZXTC.mjs");
const _page15 = () => import("./logout_bOF4M5u2.mjs");
const _page16 = () => import("./create_Cl5FEgPy.mjs");
const _page17 = () => import("./confirm_cP0MnBDm.mjs");
const _page18 = () => import("./label_DuEjYKaW.mjs");
const _page19 = () => import("./approve_BUqd8FbD.mjs");
const _page20 = () => import("./reject_DU4nWP51.mjs");
const _page21 = () => import("./index_s1BwOz8T.mjs");
const _page22 = () => import("./step-up_CqqCBoTo.mjs");
const _page23 = () => import("./uploads__9ul-7Lp.mjs");
const _page24 = () => import("./_variantId__DlEC72nb.mjs");
const _page25 = () => import("./checkout__6jbg7YP.mjs");
const _page26 = () => import("./order-track_CLma5IsY.mjs");
const _page27 = () => import("./orders_CKY19a5U.mjs");
const _page28 = () => import("./index_AH1ceJhv.mjs");
const _page29 = () => import("./index_DIp3Mg1e.mjs");
const _page30 = () => import("./index_B6rO3MRI.mjs");
const _page31 = () => import("./index_CnQckOW2.mjs");
const _page32 = () => import("./index_W8Hi7eYU.mjs");
const _page33 = () => import("./index_C5jU1LQA.mjs");
const _page34 = () => import("./login_JdV5o92G.mjs");
const _page35 = () => import("./index_DCy9xF0Z.mjs");
const _page36 = () => import("./index_BfEwkAYd.mjs");
const _page37 = () => import("./_id__DtVq5sXd.mjs");
const _page38 = () => import("./index_CdVBV3Y5.mjs");
const _page39 = () => import("./courier_BRm3jzht.mjs");
const _page40 = () => import("./packed_ByFzFczJ.mjs");
const _page41 = () => import("./slips_B98uEZBN.mjs");
const _page42 = () => import("./index_DNbAIGGP.mjs");
const _page43 = () => import("./_id__gHvP1a7j.mjs");
const _page44 = () => import("./index_DAWbGEUk.mjs");
const _page45 = () => import("./index_GdRhhxsa.mjs");
const _page46 = () => import("./index_B8vm4GgX.mjs");
const _page47 = () => import("./instore_DHjJTucs.mjs");
const _page48 = () => import("./new_8JLQFw_W.mjs");
const _page49 = () => import("./notes_BhgBD4dN.mjs");
const _page50 = () => import("./orders_fdHBLWZP.mjs");
const _page51 = () => import("./search_CVkLeTfK.mjs");
const _page52 = () => import("./index_FafEQsgT.mjs");
const _page53 = () => import("./index_DrJ25IDf.mjs");
const _page54 = () => import("./escalations_ebBK1T9u.mjs");
const _page55 = () => import("./search_DyMyhzj2.mjs");
const _page56 = () => import("./index_Bg9oOOZY.mjs");
const _page57 = () => import("./index_B6G4NjUv.mjs");
const _page58 = () => import("./index_TCdh3jDK.mjs");
const pageMap = /* @__PURE__ */ new Map([
  ...
  ["src/pages/api/fraud/check.ts", _page2],
  ["src/pages/api/orders/track.ts", _page3],
  ["src/pages/api/payments/create.ts", _page4],
  ["src/pages/api/payments/status/[id].ts", _page5],
  ["src/pages/api/payments/webhook.ts", _page6],
  ["src/pages/api/search.ts", _page7],
  ["src/pages/api/staff/ai/generate-product-content.ts", _page8],
  ["src/pages/api/staff/api-code/index.ts", _page9],
  ["src/pages/api/staff/api-keys/index.ts", _page10],
  ["src/pages/api/staff/coupons/[id].ts", _page11],
  ["src/pages/api/staff/coupons/index.ts", _page12],
  ["src/pages/api/staff/fraud/override.ts", _page13],
  ["src/pages/api/staff/login.ts", _page14],
  ["src/pages/api/staff/logout.ts", _page15],
  ["src/pages/api/staff/orders/create.ts", _page16],
  ["src/pages/api/staff/orders/[id]/confirm.ts", _page17],
  ["src/pages/api/staff/orders/[id]/label.ts", _page18],
  ["src/pages/api/staff/returns/[id]/approve.ts", _page19],
  ["src/pages/api/staff/returns/[id]/reject.ts", _page20],
  ["src/pages/api/staff/returns/index.ts", _page21],
  ["src/pages/api/staff/step-up.ts", _page22],
  ["src/pages/api/staff/uploads.ts", _page23],
  ["src/pages/api/stock/[variantId].ts", _page24],
  ["src/pages/checkout.astro", _page25],
  ["src/pages/order-track.astro", _page26],
  ["src/pages/orders.astro", _page27],
  ["src/pages/staff/api-code/index.astro", _page28],
  ["src/pages/staff/audit/index.astro", _page29],
  ["src/pages/staff/backups/index.astro", _page30],
  ["src/pages/staff/coupons/index.astro", _page31],
  ["src/pages/staff/fraud/index.astro", _page32],
  ["src/pages/staff/inventory/index.astro", _page33],
  ["src/pages/staff/login.astro", _page34],
  ["src/pages/staff/media/index.astro", _page35],
  ["src/pages/staff/media-admin/index.astro", _page36],
  ["src/pages/staff/orders/[id].astro", _page37],
  ["src/pages/staff/orders/index.astro", _page38],
  ["src/pages/staff/packing/courier.astro", _page39],
  ["src/pages/staff/packing/packed.astro", _page40],
  ["src/pages/staff/packing/slips.astro", _page41],
  ["src/pages/staff/packing/index.astro", _page42],
  ["src/pages/staff/products/[id].astro", _page43],
  ["src/pages/staff/products/index.astro", _page44],
  ["src/pages/staff/reports/index.astro", _page45],
  ["src/pages/staff/roles/index.astro", _page46],
  ["src/pages/staff/sales/instore.astro", _page47],
  ["src/pages/staff/sales/new.astro", _page48],
  ["src/pages/staff/sales/notes.astro", _page49],
  ["src/pages/staff/sales/orders.astro", _page50],
  ["src/pages/staff/sales/search.astro", _page51],
  ["src/pages/staff/sales/index.astro", _page52],
  ["src/pages/staff/settings/index.astro", _page53],
  ["src/pages/staff/support/escalations.astro", _page54],
  ["src/pages/staff/support/search.astro", _page55],
  ["src/pages/staff/support/index.astro", _page56],
  ["src/pages/staff/users/index.astro", _page57],
  ["src/pages/staff/index.astro", _page58]
]);
const _manifest = deserializeManifest({"rootDir":"file:///D:/Antigravity/zabir-boutiques/","cacheDir":"file:///D:/Antigravity/zabir-boutiques/node_modules/.astro/","outDir":"file:///D:/Antigravity/zabir-boutiques/dist/","srcDir":"file:///D:/Antigravity/zabir-boutiques/src/","publicDir":"file:///D:/Antigravity/zabir-boutiques/public/","buildClientDir":"file:///D:/Antigravity/zabir-boutiques/dist/client/","buildServerDir":"file:///D:/Antigravity/zabir-boutiques/dist/server/","adapterName":"@astrojs/cloudflare","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/_image","component":"node_modules/@astrojs/cloudflare/dist/entrypoints/image-passthrough-endpoint.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/checkout","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/checkout\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"checkout","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/checkout.ts","pathname":"/api/checkout","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/fraud/check","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/fraud\\/check\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"fraud","dynamic":false,"spread":false}],[{"content":"check","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/fraud/check.ts","pathname":"/api/fraud/check","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/orders/track","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/orders\\/track\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"orders","dynamic":false,"spread":false}],[{"content":"track","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/orders/track.ts","pathname":"/api/orders/track","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/payments/create","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/payments\\/create\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"payments","dynamic":false,"spread":false}],[{"content":"create","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/payments/create.ts","pathname":"/api/payments/create","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/payments/status/[id]","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/payments\\/status\\/([^/]+?)\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"payments","dynamic":false,"spread":false}],[{"content":"status","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/api/payments/status/[id].ts","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/payments/webhook","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/payments\\/webhook\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"payments","dynamic":false,"spread":false}],[{"content":"webhook","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/payments/webhook.ts","pathname":"/api/payments/webhook","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/search","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/search\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"search","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/search.ts","pathname":"/api/search","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/staff/ai/generate-product-content","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/staff\\/ai\\/generate-product-content\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"staff","dynamic":false,"spread":false}],[{"content":"ai","dynamic":false,"spread":false}],[{"content":"generate-product-content","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/staff/ai/generate-product-content.ts","pathname":"/api/staff/ai/generate-product-content","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/staff/api-code","isIndex":true,"type":"endpoint","pattern":"^\\/api\\/staff\\/api-code\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"staff","dynamic":false,"spread":false}],[{"content":"api-code","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/staff/api-code/index.ts","pathname":"/api/staff/api-code","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/staff/api-keys","isIndex":true,"type":"endpoint","pattern":"^\\/api\\/staff\\/api-keys\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"staff","dynamic":false,"spread":false}],[{"content":"api-keys","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/staff/api-keys/index.ts","pathname":"/api/staff/api-keys","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/staff/coupons/[id]","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/staff\\/coupons\\/([^/]+?)\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"staff","dynamic":false,"spread":false}],[{"content":"coupons","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/api/staff/coupons/[id].ts","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/staff/coupons","isIndex":true,"type":"endpoint","pattern":"^\\/api\\/staff\\/coupons\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"staff","dynamic":false,"spread":false}],[{"content":"coupons","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/staff/coupons/index.ts","pathname":"/api/staff/coupons","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/staff/fraud/override","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/staff\\/fraud\\/override\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"staff","dynamic":false,"spread":false}],[{"content":"fraud","dynamic":false,"spread":false}],[{"content":"override","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/staff/fraud/override.ts","pathname":"/api/staff/fraud/override","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/staff/login","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/staff\\/login\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"staff","dynamic":false,"spread":false}],[{"content":"login","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/staff/login.ts","pathname":"/api/staff/login","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/staff/logout","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/staff\\/logout\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"staff","dynamic":false,"spread":false}],[{"content":"logout","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/staff/logout.ts","pathname":"/api/staff/logout","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/staff/orders/create","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/staff\\/orders\\/create\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"staff","dynamic":false,"spread":false}],[{"content":"orders","dynamic":false,"spread":false}],[{"content":"create","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/staff/orders/create.ts","pathname":"/api/staff/orders/create","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/staff/orders/[id]/confirm","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/staff\\/orders\\/([^/]+?)\\/confirm\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"staff","dynamic":false,"spread":false}],[{"content":"orders","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}],[{"content":"confirm","dynamic":false,"spread":false}]],"params":["id"],"component":"src/pages/api/staff/orders/[id]/confirm.ts","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/staff/orders/[id]/label","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/staff\\/orders\\/([^/]+?)\\/label\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"staff","dynamic":false,"spread":false}],[{"content":"orders","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}],[{"content":"label","dynamic":false,"spread":false}]],"params":["id"],"component":"src/pages/api/staff/orders/[id]/label.ts","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/staff/returns/[id]/approve","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/staff\\/returns\\/([^/]+?)\\/approve\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"staff","dynamic":false,"spread":false}],[{"content":"returns","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}],[{"content":"approve","dynamic":false,"spread":false}]],"params":["id"],"component":"src/pages/api/staff/returns/[id]/approve.ts","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/staff/returns/[id]/reject","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/staff\\/returns\\/([^/]+?)\\/reject\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"staff","dynamic":false,"spread":false}],[{"content":"returns","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}],[{"content":"reject","dynamic":false,"spread":false}]],"params":["id"],"component":"src/pages/api/staff/returns/[id]/reject.ts","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/staff/returns","isIndex":true,"type":"endpoint","pattern":"^\\/api\\/staff\\/returns\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"staff","dynamic":false,"spread":false}],[{"content":"returns","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/staff/returns/index.ts","pathname":"/api/staff/returns","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/staff/step-up","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/staff\\/step-up\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"staff","dynamic":false,"spread":false}],[{"content":"step-up","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/staff/step-up.ts","pathname":"/api/staff/step-up","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/staff/uploads","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/staff\\/uploads\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"staff","dynamic":false,"spread":false}],[{"content":"uploads","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/staff/uploads.ts","pathname":"/api/staff/uploads","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/api/stock/[variantId]","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/stock\\/([^/]+?)\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"stock","dynamic":false,"spread":false}],[{"content":"variantId","dynamic":true,"spread":false}]],"params":["variantId"],"component":"src/pages/api/stock/[variantId].ts","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/categories/[slug]","isIndex":false,"type":"page","pattern":"^\\/categories\\/([^/]+?)\\/?$","segments":[[{"content":"categories","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/categories/[slug].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/checkout","isIndex":false,"type":"page","pattern":"^\\/checkout\\/?$","segments":[[{"content":"checkout","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/checkout.astro","pathname":"/checkout","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/order-track","isIndex":false,"type":"page","pattern":"^\\/order-track\\/?$","segments":[[{"content":"order-track","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/order-track.astro","pathname":"/order-track","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/orders","isIndex":false,"type":"page","pattern":"^\\/orders\\/?$","segments":[[{"content":"orders","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/orders.astro","pathname":"/orders","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/products/[slug]","isIndex":false,"type":"page","pattern":"^\\/products\\/([^/]+?)\\/?$","segments":[[{"content":"products","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/products/[slug].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/api-code","isIndex":true,"type":"page","pattern":"^\\/staff\\/api-code\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"api-code","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/api-code/index.astro","pathname":"/staff/api-code","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/audit","isIndex":true,"type":"page","pattern":"^\\/staff\\/audit\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"audit","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/audit/index.astro","pathname":"/staff/audit","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/backups","isIndex":true,"type":"page","pattern":"^\\/staff\\/backups\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"backups","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/backups/index.astro","pathname":"/staff/backups","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/coupons","isIndex":true,"type":"page","pattern":"^\\/staff\\/coupons\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"coupons","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/coupons/index.astro","pathname":"/staff/coupons","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/fraud","isIndex":true,"type":"page","pattern":"^\\/staff\\/fraud\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"fraud","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/fraud/index.astro","pathname":"/staff/fraud","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/inventory","isIndex":true,"type":"page","pattern":"^\\/staff\\/inventory\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"inventory","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/inventory/index.astro","pathname":"/staff/inventory","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/login","isIndex":false,"type":"page","pattern":"^\\/staff\\/login\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"login","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/login.astro","pathname":"/staff/login","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/media","isIndex":true,"type":"page","pattern":"^\\/staff\\/media\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"media","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/media/index.astro","pathname":"/staff/media","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/media-admin","isIndex":true,"type":"page","pattern":"^\\/staff\\/media-admin\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"media-admin","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/media-admin/index.astro","pathname":"/staff/media-admin","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/orders/[id]","isIndex":false,"type":"page","pattern":"^\\/staff\\/orders\\/([^/]+?)\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"orders","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/staff/orders/[id].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/orders","isIndex":true,"type":"page","pattern":"^\\/staff\\/orders\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"orders","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/orders/index.astro","pathname":"/staff/orders","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/packing/courier","isIndex":false,"type":"page","pattern":"^\\/staff\\/packing\\/courier\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"packing","dynamic":false,"spread":false}],[{"content":"courier","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/packing/courier.astro","pathname":"/staff/packing/courier","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/packing/packed","isIndex":false,"type":"page","pattern":"^\\/staff\\/packing\\/packed\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"packing","dynamic":false,"spread":false}],[{"content":"packed","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/packing/packed.astro","pathname":"/staff/packing/packed","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/packing/slips","isIndex":false,"type":"page","pattern":"^\\/staff\\/packing\\/slips\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"packing","dynamic":false,"spread":false}],[{"content":"slips","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/packing/slips.astro","pathname":"/staff/packing/slips","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/packing","isIndex":true,"type":"page","pattern":"^\\/staff\\/packing\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"packing","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/packing/index.astro","pathname":"/staff/packing","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/products/[id]","isIndex":false,"type":"page","pattern":"^\\/staff\\/products\\/([^/]+?)\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"products","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/staff/products/[id].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/products","isIndex":true,"type":"page","pattern":"^\\/staff\\/products\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"products","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/products/index.astro","pathname":"/staff/products","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/reports","isIndex":true,"type":"page","pattern":"^\\/staff\\/reports\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"reports","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/reports/index.astro","pathname":"/staff/reports","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/roles","isIndex":true,"type":"page","pattern":"^\\/staff\\/roles\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"roles","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/roles/index.astro","pathname":"/staff/roles","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/sales/instore","isIndex":false,"type":"page","pattern":"^\\/staff\\/sales\\/instore\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"sales","dynamic":false,"spread":false}],[{"content":"instore","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/sales/instore.astro","pathname":"/staff/sales/instore","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/sales/new","isIndex":false,"type":"page","pattern":"^\\/staff\\/sales\\/new\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"sales","dynamic":false,"spread":false}],[{"content":"new","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/sales/new.astro","pathname":"/staff/sales/new","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/sales/notes","isIndex":false,"type":"page","pattern":"^\\/staff\\/sales\\/notes\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"sales","dynamic":false,"spread":false}],[{"content":"notes","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/sales/notes.astro","pathname":"/staff/sales/notes","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/sales/orders","isIndex":false,"type":"page","pattern":"^\\/staff\\/sales\\/orders\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"sales","dynamic":false,"spread":false}],[{"content":"orders","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/sales/orders.astro","pathname":"/staff/sales/orders","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/sales/search","isIndex":false,"type":"page","pattern":"^\\/staff\\/sales\\/search\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"sales","dynamic":false,"spread":false}],[{"content":"search","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/sales/search.astro","pathname":"/staff/sales/search","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/sales","isIndex":true,"type":"page","pattern":"^\\/staff\\/sales\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"sales","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/sales/index.astro","pathname":"/staff/sales","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/settings","isIndex":true,"type":"page","pattern":"^\\/staff\\/settings\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"settings","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/settings/index.astro","pathname":"/staff/settings","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/support/escalations","isIndex":false,"type":"page","pattern":"^\\/staff\\/support\\/escalations\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"support","dynamic":false,"spread":false}],[{"content":"escalations","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/support/escalations.astro","pathname":"/staff/support/escalations","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/support/search","isIndex":false,"type":"page","pattern":"^\\/staff\\/support\\/search\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"support","dynamic":false,"spread":false}],[{"content":"search","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/support/search.astro","pathname":"/staff/support/search","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/support","isIndex":true,"type":"page","pattern":"^\\/staff\\/support\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"support","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/support/index.astro","pathname":"/staff/support","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff/users","isIndex":true,"type":"page","pattern":"^\\/staff\\/users\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}],[{"content":"users","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/users/index.astro","pathname":"/staff/users","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[{"type":"external","src":"_astro/global.m-8Lv313.css"}],"routeData":{"route":"/staff","isIndex":true,"type":"page","pattern":"^\\/staff\\/?$","segments":[[{"content":"staff","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/staff/index.astro","pathname":"/staff","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.B9eF5IcF.js"}],"styles":[],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","site":"https://zabirboutiques.com","base":"/","trailingSlash":"ignore","compressHTML":true,"experimentalQueuedRendering":{"enabled":false,"poolSize":0,"contentCache":false},"componentMetadata":[["D:/Antigravity/zabir-boutiques/src/pages/categories/[slug].astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/index.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/products/[slug].astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/api-code/index.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/audit/index.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/backups/index.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/coupons/index.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/fraud/index.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/index.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/inventory/index.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/media-admin/index.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/media/index.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/orders/[id].astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/orders/index.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/packing/courier.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/packing/index.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/packing/packed.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/packing/slips.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/products/[id].astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/products/index.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/reports/index.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/roles/index.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/sales/index.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/sales/instore.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/sales/new.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/sales/notes.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/sales/orders.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/sales/search.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/settings/index.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/support/escalations.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/support/index.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/support/search.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/users/index.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/staff/login.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/checkout.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/order-track.astro",{"propagation":"none","containsHead":true}],["D:/Antigravity/zabir-boutiques/src/pages/orders.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"D:/Antigravity/zabir-boutiques/src/lib/queue-publisher.ts":"chunks/queue-publisher_D3CwF_TA.mjs","D:/Antigravity/zabir-boutiques/src/lib/maintenance/partial-prepay.ts":"chunks/partial-prepay_C6TCu-y0.mjs","D:/Antigravity/zabir-boutiques/src/lib/maintenance/reconciliation.ts":"chunks/reconciliation_C1TpCyLz.mjs","D:/Antigravity/zabir-boutiques/src/lib/maintenance/sitemap.ts":"chunks/sitemap_B6g46jNp.mjs","D:/Antigravity/zabir-boutiques/src/lib/tinify.ts":"chunks/tinify_Bgri1Y52.mjs","D:/Antigravity/zabir-boutiques/src/lib/maintenance/idempotency.ts":"chunks/idempotency_CO3IC1mN.mjs","D:/Antigravity/zabir-boutiques/src/lib/maintenance/inventory-reconcile.ts":"chunks/inventory-reconcile_DQy_6rUh.mjs","D:/Antigravity/zabir-boutiques/src/lib/maintenance/backup.ts":"chunks/backup_l7iqoZhn.mjs","D:/Antigravity/zabir-boutiques/src/lib/maintenance/archive.ts":"chunks/archive_f26U-gzZ.mjs","D:/Antigravity/zabir-boutiques/src/lib/fraud.ts":"chunks/fraud_BFITCOJK.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_DsBX4kaI.mjs","D:/Antigravity/zabir-boutiques/src/lib/sessions.ts":"chunks/sessions_BoTS18Dm.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_CFl7y3Qj.mjs","\u0000virtual:astro:page:src/pages/categories/[slug]@_@astro":"chunks/_slug__BNuBca4F.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_B9rNgPJt.mjs","\u0000virtual:astro:page:src/pages/products/[slug]@_@astro":"chunks/_slug__DoKzfXtZ.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_Csu6PJY6.mjs","\u0000virtual:astro:middleware":"virtual_astro_middleware.mjs","D:/Antigravity/zabir-boutiques/node_modules/@astrojs/cloudflare/dist/utils/static-image-collection.js":"chunks/static-image-collection_CIBVMhuF.mjs","virtual:cloudflare/worker-entry":"entry.mjs","D:/Antigravity/zabir-boutiques/node_modules/@astrojs/cloudflare/dist/entrypoints/image-service-workerd.js":"chunks/image-service-workerd_Kqic3UoW.mjs","\u0000virtual:astro:page:src/pages/api/fraud/check@_@ts":"chunks/check_B_EMctBi.mjs","\u0000virtual:astro:page:src/pages/api/orders/track@_@ts":"chunks/track_CV5TfOwA.mjs","\u0000virtual:astro:page:src/pages/api/payments/create@_@ts":"chunks/create_DKTSp6Sn.mjs","\u0000virtual:astro:page:src/pages/api/payments/status/[id]@_@ts":"chunks/_id__DtEo4TUx.mjs","\u0000virtual:astro:page:src/pages/api/payments/webhook@_@ts":"chunks/webhook_DwICHqBE.mjs","\u0000virtual:astro:page:src/pages/api/staff/api-code/index@_@ts":"chunks/index_DuPUWDZH.mjs","\u0000virtual:astro:page:src/pages/api/staff/coupons/[id]@_@ts":"chunks/_id__D8oks4X1.mjs","\u0000virtual:astro:page:src/pages/api/staff/coupons/index@_@ts":"chunks/index_BT7bzJl3.mjs","\u0000virtual:astro:page:src/pages/api/staff/fraud/override@_@ts":"chunks/override_H1zyAkHr.mjs","\u0000virtual:astro:page:src/pages/api/staff/login@_@ts":"chunks/login_BmVUZXTC.mjs","\u0000virtual:astro:page:src/pages/api/staff/logout@_@ts":"chunks/logout_bOF4M5u2.mjs","\u0000virtual:astro:page:src/pages/api/staff/orders/create@_@ts":"chunks/create_Cl5FEgPy.mjs","\u0000virtual:astro:page:src/pages/api/staff/orders/[id]/confirm@_@ts":"chunks/confirm_cP0MnBDm.mjs","\u0000virtual:astro:page:src/pages/api/staff/orders/[id]/label@_@ts":"chunks/label_DuEjYKaW.mjs","\u0000virtual:astro:page:src/pages/api/staff/returns/[id]/reject@_@ts":"chunks/reject_DU4nWP51.mjs","\u0000virtual:astro:page:src/pages/api/staff/returns/index@_@ts":"chunks/index_s1BwOz8T.mjs","\u0000virtual:astro:page:src/pages/api/staff/step-up@_@ts":"chunks/step-up_CqqCBoTo.mjs","\u0000virtual:astro:page:src/pages/api/stock/[variantId]@_@ts":"chunks/_variantId__DlEC72nb.mjs","\u0000virtual:astro:page:src/pages/order-track@_@astro":"chunks/order-track_CLma5IsY.mjs","\u0000virtual:astro:page:src/pages/orders@_@astro":"chunks/orders_CKY19a5U.mjs","\u0000virtual:astro:page:src/pages/staff/api-code/index@_@astro":"chunks/index_AH1ceJhv.mjs","\u0000virtual:astro:page:src/pages/staff/audit/index@_@astro":"chunks/index_DIp3Mg1e.mjs","\u0000virtual:astro:page:src/pages/staff/backups/index@_@astro":"chunks/index_B6rO3MRI.mjs","\u0000virtual:astro:page:src/pages/staff/coupons/index@_@astro":"chunks/index_CnQckOW2.mjs","\u0000virtual:astro:page:src/pages/staff/fraud/index@_@astro":"chunks/index_W8Hi7eYU.mjs","\u0000virtual:astro:page:src/pages/staff/inventory/index@_@astro":"chunks/index_C5jU1LQA.mjs","\u0000virtual:astro:page:src/pages/staff/login@_@astro":"chunks/login_JdV5o92G.mjs","\u0000virtual:astro:page:src/pages/staff/media/index@_@astro":"chunks/index_DCy9xF0Z.mjs","\u0000virtual:astro:page:src/pages/staff/media-admin/index@_@astro":"chunks/index_BfEwkAYd.mjs","\u0000virtual:astro:page:src/pages/staff/orders/[id]@_@astro":"chunks/_id__DtVq5sXd.mjs","\u0000virtual:astro:page:src/pages/staff/orders/index@_@astro":"chunks/index_CdVBV3Y5.mjs","\u0000virtual:astro:page:src/pages/staff/packing/courier@_@astro":"chunks/courier_BRm3jzht.mjs","\u0000virtual:astro:page:src/pages/staff/packing/packed@_@astro":"chunks/packed_ByFzFczJ.mjs","\u0000virtual:astro:page:src/pages/staff/packing/slips@_@astro":"chunks/slips_B98uEZBN.mjs","\u0000virtual:astro:page:src/pages/staff/packing/index@_@astro":"chunks/index_DNbAIGGP.mjs","\u0000virtual:astro:page:src/pages/staff/products/[id]@_@astro":"chunks/_id__gHvP1a7j.mjs","\u0000virtual:astro:page:src/pages/staff/products/index@_@astro":"chunks/index_DAWbGEUk.mjs","\u0000virtual:astro:page:src/pages/staff/reports/index@_@astro":"chunks/index_GdRhhxsa.mjs","\u0000virtual:astro:page:src/pages/staff/roles/index@_@astro":"chunks/index_B8vm4GgX.mjs","\u0000virtual:astro:page:src/pages/staff/sales/instore@_@astro":"chunks/instore_DHjJTucs.mjs","\u0000virtual:astro:page:src/pages/staff/sales/new@_@astro":"chunks/new_8JLQFw_W.mjs","\u0000virtual:astro:page:src/pages/staff/sales/notes@_@astro":"chunks/notes_BhgBD4dN.mjs","\u0000virtual:astro:page:src/pages/staff/sales/orders@_@astro":"chunks/orders_fdHBLWZP.mjs","\u0000virtual:astro:page:src/pages/staff/sales/search@_@astro":"chunks/search_CVkLeTfK.mjs","\u0000virtual:astro:page:src/pages/staff/sales/index@_@astro":"chunks/index_FafEQsgT.mjs","\u0000virtual:astro:page:src/pages/staff/settings/index@_@astro":"chunks/index_DrJ25IDf.mjs","\u0000virtual:astro:page:src/pages/staff/support/escalations@_@astro":"chunks/escalations_ebBK1T9u.mjs","\u0000virtual:astro:page:src/pages/staff/support/search@_@astro":"chunks/search_DyMyhzj2.mjs","\u0000virtual:astro:page:src/pages/staff/support/index@_@astro":"chunks/index_Bg9oOOZY.mjs","\u0000virtual:astro:page:src/pages/staff/users/index@_@astro":"chunks/index_B6G4NjUv.mjs","\u0000virtual:astro:page:src/pages/staff/index@_@astro":"chunks/index_TCdh3jDK.mjs","\u0000virtual:astro:page:src/pages/api/checkout@_@ts":"chunks/checkout_kPPoCdyZ.mjs","\u0000virtual:astro:page:src/pages/api/search@_@ts":"chunks/search_CzZBN1Ic.mjs","\u0000virtual:astro:page:src/pages/api/staff/ai/generate-product-content@_@ts":"chunks/generate-product-content_CRIbW4oc.mjs","\u0000virtual:astro:page:src/pages/api/staff/api-keys/index@_@ts":"chunks/index_C72KvVBh.mjs","\u0000virtual:astro:page:src/pages/api/staff/returns/[id]/approve@_@ts":"chunks/approve_BUqd8FbD.mjs","\u0000virtual:astro:page:src/pages/api/staff/uploads@_@ts":"chunks/uploads__9ul-7Lp.mjs","\u0000virtual:astro:page:src/pages/checkout@_@astro":"chunks/checkout__6jbg7YP.mjs","D:/Antigravity/zabir-boutiques/src/pages/staff/products/index.astro?astro&type=script&index=0&lang.ts":"_astro/index.astro_astro_type_script_index_0_lang.BZn1tEgt.js","@/islands/ThemeToggle":"_astro/ThemeToggle.CB7FvKVy.js","D:/Antigravity/zabir-boutiques/src/pages/staff/api-code/index.astro?astro&type=script&index=0&lang.ts":"_astro/index.astro_astro_type_script_index_0_lang.OpB1MWdi.js","D:/Antigravity/zabir-boutiques/src/pages/staff/sales/new.astro?astro&type=script&index=0&lang.ts":"_astro/new.astro_astro_type_script_index_0_lang.C2o0vofe.js","D:/Antigravity/zabir-boutiques/src/pages/staff/settings/index.astro?astro&type=script&index=0&lang.ts":"_astro/index.astro_astro_type_script_index_0_lang.OQTRt4Ze.js","@/islands/AddToCartButton":"_astro/AddToCartButton.DCCFsBFu.js","astro:scripts/page.js":"_astro/page.B9eF5IcF.js","@/islands/BottomNav":"_astro/BottomNav.1E6mLLqY.js","@astrojs/react/client.js":"_astro/client.BtRKo7pY.js","@/islands/GuestCheckout":"_astro/GuestCheckout.CqRBk6B0.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["D:/Antigravity/zabir-boutiques/src/pages/staff/products/index.astro?astro&type=script&index=0&lang.ts","globalThis.process??={};globalThis.process.env??={};"],["D:/Antigravity/zabir-boutiques/src/pages/staff/api-code/index.astro?astro&type=script&index=0&lang.ts","globalThis.process??={};globalThis.process.env??={};const n=[\"orders:create_assisted\",\"orders:read_own_integration\",\"stock:read_public\",\"media:upload_product_pending\",\"media:read_own\",\"webhooks:payment_status_read\"];async function a(){try{const t=await(await fetch(\"/api/staff/api-keys\")).json(),o=document.getElementById(\"keysTableBody\");if(!t.ok||!t.keys?.length){o.innerHTML='<tr><td colspan=\"7\" style=\"padding:2rem;text-align:center;color:var(--muted);\">No API keys found.</td></tr>';return}o.innerHTML=t.keys.map(e=>`<tr style=\"border-top:1px solid var(--line-soft);\">\n      <td style=\"padding:0.6rem 0.75rem;font-weight:600;\">${d(e.name)}</td>\n      <td style=\"padding:0.6rem 0.75rem;font-family:monospace;color:var(--muted);\">${d(e.key_prefix)}...</td>\n      <td style=\"padding:0.6rem 0.75rem;color:var(--muted);\">${d(s(e))}</td>\n      <td style=\"padding:0.6rem 0.75rem;\"><span style=\"padding:2px 6px;border-radius:4px;font-size:0.75rem;background:${e.is_revoked?\"#fee2e2\":\"#dcfce7\"};color:${e.is_revoked?\"#991b1b\":\"#166534\"};\">${e.is_revoked?\"Revoked\":\"Active\"}</span></td>\n      <td style=\"padding:0.6rem 0.75rem;color:var(--muted);\">${e.last_used_at?e.last_used_at.split(\" \")[0]:\"—\"}</td>\n      <td style=\"padding:0.6rem 0.75rem;color:var(--muted);\">${e.created_at?e.created_at.split(\" \")[0]:\"—\"}</td>\n      <td style=\"padding:0.6rem 0.75rem;\">${e.is_revoked?\"\":`<button style=\"padding:0.25rem 0.5rem;background:#fee2e2;color:#991b1b;border:none;border-radius:4px;cursor:pointer;font-size:0.75rem;\" onclick=\"revokeKey('${e.id}')\">Revoke</button>`}</td>\n    </tr>`).join(\"\")}catch{}}function d(r){const t=document.createElement(\"div\");return t.textContent=r,t.innerHTML}function s(r){try{const t=JSON.parse(r.scopes_json||r.permissions||\"[]\");return Array.isArray(t)?t.join(\", \"):\"\"}catch{return\"\"}}document.getElementById(\"scopeList\").innerHTML=n.map(r=>`\n  <label style=\"display:flex;align-items:center;gap:0.45rem;padding:0.35rem 0.5rem;border:1px solid var(--line);border-radius:6px;background:var(--surface);\">\n    <input type=\"checkbox\" name=\"apiScope\" value=\"${d(r)}\" />\n    <span>${d(r)}</span>\n  </label>\n`).join(\"\");a();"],["D:/Antigravity/zabir-boutiques/src/pages/staff/sales/new.astro?astro&type=script&index=0&lang.ts","globalThis.process??={};globalThis.process.env??={};const o=document.querySelector('form[action=\"/api/staff/orders/create\"]');o&&o.addEventListener(\"submit\",async d=>{d.preventDefault();const e=new FormData(o),r=[];document.querySelectorAll(\".variant-qty\").forEach(a=>{const c=parseInt(a.value||\"0\",10);c>0&&a.dataset?.variantId&&r.push({variantId:a.dataset.variantId,qty:c})});const i={channel:e.get(\"channel\"),phone:e.get(\"phone\"),name:e.get(\"name\"),address:e.get(\"address\"),items:r},s=document.cookie.match(/(?:^|;\\s*)csrf-token=([^;]+)/),f=s?decodeURIComponent(s[1]):\"\",n=await fetch(\"/api/staff/orders/create\",{method:\"POST\",headers:{\"Content-Type\":\"application/json\",\"X-CSRF-Token\":f},body:JSON.stringify(i)}),t=await n.json().catch(()=>({}));n.ok&&t.ok?(alert(\"Order created: \"+t.order_number),window.location.href=\"/staff/sales/orders\"):alert(t.message||t.error||\"Failed to create order\")});"],["D:/Antigravity/zabir-boutiques/src/pages/staff/settings/index.astro?astro&type=script&index=0&lang.ts","globalThis.process??={};globalThis.process.env??={};fetch(\"/api/staff/settings\").then(t=>t.json()).then(t=>{const e=document.getElementById(\"settings-body\");e&&t?.settings?.length?e.innerHTML=t.settings.map(n=>`<tr style=\"border-bottom:1px solid var(--line-soft);\"><td style=\"padding:0.5rem 0.75rem;font-family:monospace;\">${n.key}</td><td style=\"padding:0.5rem 0.75rem;\">${n.value}</td><td style=\"padding:0.5rem 0.75rem;color:var(--muted);\">${n.group_name}</td></tr>`).join(\"\"):e&&(e.innerHTML='<tr><td colspan=\"3\" style=\"padding:1rem;text-align:center;color:var(--muted);\">No settings found.</td></tr>')}).catch(()=>{});"]],"assets":["/favicon.ico","/favicon.svg","/manifest.json","/_redirects","/assets/product-indian.svg","/assets/product-jewelry.svg","/assets/product-pakistani.svg","/assets/product-zb-stitch.svg","/assets/zabir-logo.jpg","/assets/zb-hero.svg","/icons/icon-192.png","/icons/icon-512.png","/_astro/AddToCartButton.DCCFsBFu.js","/_astro/BottomNav.1E6mLLqY.js","/_astro/client.BtRKo7pY.js","/_astro/GuestCheckout.CqRBk6B0.js","/_astro/index.DQ_U63bv.js","/_astro/jsx-runtime.DXco-PnT.js","/_astro/page.B9eF5IcF.js","/_astro/shopping-bag.DSSdLcg9.js","/_astro/ThemeToggle.CB7FvKVy.js","/_astro/useLocalCart.CH4LtxjT.js","/_astro/catalog.m-8Lv313.css","/_astro/global.m-8Lv313.css","/_astro/page.B9eF5IcF.js","/index.html"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"z2OvvXCEbqvJ1X/wtmcQri1YehqTkxVO0w5KSJdj6+o=","sessionConfig":{"driver":"unstorage/drivers/cloudflare-kv-binding","options":{"binding":"SESSION"}},"image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
const CRON_HANDLERS = {
  ...
  "*/5 * * * *": async (env2) => {
    const { cleanExpiredReservations: cleanExpiredReservations2 } = await Promise.resolve().then(() => inventory);
    const { sweepStalePartialPrepayOrders } = await import("./partial-prepay_C6TCu-y0.mjs");
    await cleanExpiredReservations2(env2, 200);
    await sweepStalePartialPrepayOrders(env2.DB);
  },
  // Every 15 min — payment reconciliation.
  "*/15 * * * *": async (env2) => {
    const { reconcilePendingPayments } = await import("./reconciliation_C1TpCyLz.mjs");
    await reconcilePendingPayments(env2);
  },
  // Hourly — session sweep.
  "0 * * * *": async (env2) => {
    const { cleanExpiredSessions } = await import("./sessions_BoTS18Dm.mjs");
    await cleanExpiredSessions(env2.DB);
  },
  // Daily 00:00 UTC — AI daily budget reset (the counter is daily-bucketed).
  "0 0 * * *": async (env2) => {
    const cache = env2.CACHE;
    if (cache) await cache.delete("AI_DAILY_USAGE_COUNT");
  },
  // Daily 02:00 UTC — sitemap generation.
  "0 2 * * *": async (env2) => {
    const { generateSitemap } = await import("./sitemap_B6g46jNp.mjs");
    await generateSitemap(env2.DB, env2.MEDIA);
  },
  // Daily 03:00 UTC — daily maintenance (sessions + idempotency + inventory reconcile + audit).
  "0 3 * * *": async (env2) => {
    const { cleanExpiredSessions } = await import("./sessions_BoTS18Dm.mjs");
    const { retryUncompressedImages } = await import("./tinify_Bgri1Y52.mjs");
    const { cleanExpiredIdempotencyKeys } = await import("./idempotency_CO3IC1mN.mjs");
    const { recordAuditIntegrityCheck: recordAuditIntegrityCheck2, writeAuditCheckpoint: writeAuditCheckpoint2 } = await Promise.resolve().then(() => audit);
    const { reconcileInventory } = await import("./inventory-reconcile_DQy_6rUh.mjs");
    await cleanExpiredSessions(env2.DB);
    await retryUncompressedImages(env2.DB, env2.MEDIA, env2.TINIFY_API_KEY);
    await cleanExpiredIdempotencyKeys(env2.DB);
    await recordAuditIntegrityCheck2(env2.DB);
    await writeAuditCheckpoint2(env2.DB);
    await reconcileInventory(env2.DB);
  },
  // Every 6 hours — D1 backup via queue.
  "0 */6 * * *": async (env2) => {
    const { enqueueD1Backup: enqueueD1Backup2 } = await import("./queue-publisher_D3CwF_TA.mjs");
    await enqueueD1Backup2(env2, nowSql());
  },
  // Weekly Sun 09:00 UTC — backup verification.
  "0 9 * * 0": async (env2) => {
    const { verifyBackup } = await import("./backup_l7iqoZhn.mjs");
    await verifyBackup(env2.DB, env2.BACKUPS);
  },
  // Monthly 1st 05:00 UTC — archive old events to R2.
  "0 5 1 * *": async (env2) => {
    const { archiveOldEvents } = await import("./archive_f26U-gzZ.mjs");
    await archiveOldEvents(env2.DB, env2.BACKUPS, env2.AUDIT_LEDGER_SECRET);
  }
};
async function dispatchCron(cron, env2) {
...
function takaStringToPaisa(amount) {
  if (typeof amount !== "string" && typeof amount !== "number") return null;
  const value = Number(amount);
  if (!Number.isFinite(value) || value < 0) return null;
  return Math.round(value * 100);
}
async function verifyUddoktaPayment(invoiceId, apiKey, baseUrl) {
  ...
  const empty = { status: "failed", amountPaisa: null, verifiedInvoiceId: null, metadata: null, rawResponse };
...
async function getAuditChainHead(db) {
  return db.prepare(
...
async function computeHashChain(db, entry, now) {
  ...
  const secret = env?.AUDIT_LEDGER_SECRET;
  const chainHash = secret ? await hmacSha256Hex(payload, secret) : await sha256Hex(payload);
...
async function writeCriticalAuditLog(db, entry) {
...
async function verifyAuditChain(db, limit = 1e3) {
...
async function writeAuditCheckpoint(db) {
  try {
    const head = await getAuditChainHead(db);
    if (!head) return;
    await db.prepare(
...
async function recordAuditIntegrityCheck(db, limit = 1e4) {
...
const audit = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  clientIp,
...
async function trackMetric(env2, event) {
  if (!env2.ANALYTICS) return;
  try {
    const doubles = [];
    const blobs = [];
    const indexes = [event.name, ...event.indexes ?? []];
    if (event.doubles) {
...
async function doReserve(env2, variantId, qty) {
  if (!env2.VARIANT_INVENTORY) return d1OnlyReserve(env2, variantId, qty);
  const id = env2.VARIANT_INVENTORY.idFromName(variantId);
  const stub = env2.VARIANT_INVENTORY.get(id);
  const res = await stub.fetch("https://do/reserve", {
    method: "POST",
    body: JSON.stringify({ qty, variantId, env: { DB: env2.DB } })
  });
  return await res.json();
}
async function doRelease(env2, variantId, qty) {
  if (!env2.VARIANT_INVENTORY) return;
  const id = env2.VARIANT_INVENTORY.idFromName(variantId);
  const stub = env2.VARIANT_INVENTORY.get(id);
...
async function doSyncFromD1(env2, variantId, stock, reserved) {
  if (!env2.VARIANT_INVENTORY) return;
  const id = env2.VARIANT_INVENTORY.idFromName(variantId);
  const stub = env2.VARIANT_INVENTORY.get(id);
  await stub.fetch("https://do/sync", {
    method: "POST",
    body: JSON.stringify({ stock, reserved, variantId, env: { DB: env2.DB } })
  });
}
async function d1OnlyReserve(env2, variantId, qty) {
  const row = await env2.DB.prepare("SELECT (quantity - reserved_quantity) AS available FROM inventory_items WHERE variant_id = ?1").bind(variantId).first();
...
async function reserveVariants(env2, items, now) {
  const db = env2.DB;
  ...
  if (env2.VARIANT_INVENTORY) {
    for (const item of items) {
      const r = await doReserve(env2, item.variantId, item.qty);
      if (!r.ok) {
        for (const prev of items) {
          if (prev.variantId === item.variantId) break;
          await doRelease(env2, prev.variantId, prev.qty);
        }
        return { ok: false, failedVariantId: item.variantId };
      }
    }
  }
  const reserveStmts = items.map(
    (item) => db.prepare(
  ...
  if (failedIndex === -1) {
    if (env2.VARIANT_INVENTORY) {
      await Promise.all(items.map(async (item) => {
        const row = await db.prepare("SELECT quantity, reserved_quantity FROM inventory_items WHERE variant_id = ?1").bind(item.variantId).first();
        if (row) await doSyncFromD1(env2, item.variantId, row.quantity, row.reserved_quantity);
      }));
    }
    return { ok: true };
  }
  ...
  if (successfulItems.length > 0) {
    const releaseStmts = successfulItems.map(
      (item) => db.prepare(
        `UPDATE inventory_items
         SET reserved_quantity = reserved_quantity - ?1, updated_at = ?3
    ...
    if (env2.VARIANT_INVENTORY) {
      await Promise.all(successfulItems.map((item) => doRelease(env2, item.variantId, item.qty)));
    }
  }
  if (env2.VARIANT_INVENTORY) {
    await doRelease(env2, items[failedIndex].variantId, items[failedIndex].qty);
  }
  return { ok: false, failedVariantId: items[failedIndex].variantId };
}
async function releaseReservedVariants(env2, items, now) {
  if (items.length === 0) return;
  const db = env2.DB;
  const releaseStmts = items.map(
    (item) => db.prepare(
      `UPDATE inventory_items
       SET reserved_quantity = reserved_quantity - ?1, updated_at = ?3
       WHERE variant_id = ?2 AND reserved_quantity >= ?1`
  ...
  await db.batch(releaseStmts, { atomic: true });
  if (env2.VARIANT_INVENTORY) {
    await Promise.all(items.map((item) => doRelease(env2, item.variantId, item.qty)));
  }
}
async function cleanExpiredReservations(env2, maxRows = 200) {
  const db = env2.DB;
  const now = nowSql();
  ...
  if (env2.VARIANT_INVENTORY) {
    await Promise.all(variantIds.map(async (variantId) => {
      const row = await db.prepare("SELECT quantity, reserved_quantity FROM inventory_items WHERE variant_id = ?1").bind(variantId).first();
      if (row) await doSyncFromD1(env2, variantId, row.quantity, row.reserved_quantity);
    }));
  }
}
async function confirmReservedVariants(env2, items, now) {
  if (items.length === 0) return { ok: true };
  const db = env2.DB;
  const deductStmts = items.map(
    (item) => db.prepare(
      `UPDATE inventory_items
...
const inventory = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  confirmReservedVariants,
  releaseReservedVariants,
  reserveVariants
}, Symbol.toStringTag, { value: "Module" }));
async function enqueuePaymentWebhook(env2, invoiceId) {
  if (!env2.PAYMENT_WEBHOOKS) return;
  await env2.PAYMENT_WEBHOOKS.send({ invoiceId, receivedAt: nowSql() });
}
async function handlePaymentWebhookBatch(batch, env2) {
  for (const msg of batch.messages) {
    try {
      const { invoiceId } = msg.body;
      const verified = await verifyUddoktaPayment(invoiceId, env2.UDDOKTAPAY_API_KEY, env2.UDDOKTAPAY_BASE_URL);
      if (verified.status !== "paid") {
        msg.ack();
        continue;
      }
      const payment = await env2.DB.prepare("SELECT id, order_id, amount_paisa, status FROM payments WHERE invoice_id = ?1").bind(invoiceId).first();
      if (!payment) {
        msg.ack();
        continue;
      }
      const eventResult = await env2.DB.prepare(
      ...
      ).bind(crypto.randomUUID(), payment.id, invoiceId, verified.rawResponse ?? "", nowSql()).run();
      if (eventResult.meta.changes === 0) {
        msg.ack();
        continue;
      }
      await env2.DB.prepare("UPDATE payments SET status = 'paid', verified_at = ?2, updated_at = ?2 WHERE id = ?1").bind(payment.id, nowSql()).run();
      const reservations = await env2.DB.prepare("SELECT id, variant_id, quantity FROM stock_reservations WHERE order_id = ?1 AND status = 'active'").bind(payment.order_id).all();
      const items = (reservations.results ?? []).map((r) => ({ variantId: r.variant_id, qty: r.quantity }));
      if (items.length > 0) {
        await confirmReservedVariants({ DB: env2.DB }, items, nowSql());
        await env2.DB.prepare("UPDATE stock_reservations SET status = 'confirmed', updated_at = ?2 WHERE order_id = ?1 AND status = 'active'").bind(payment.order_id, nowSql()).run();
      }
      await env2.DB.prepare("UPDATE orders SET payment_status = 'paid', status = 'payment_verified', updated_at = ?2 WHERE id = ?1").bind(payment.order_id, nowSql()).run();
      await trackMetric(env2, {
        name: "orders_created",
...
async function handleOrderEmailBatch(batch, env2) {
  for (const msg of batch.messages) {
    try {
      const now = nowSql();
      ...
      ).bind(crypto.randomUUID(), msg.body.orderId, msg.body.emailType, "", now).run();
      msg.ack();
    } catch (err) {
...
async function handleImageProcessingBatch(batch, _env) {
  for (const msg of batch.messages) {
    try {
      msg.ack();
    } catch (err) {
...
async function handleFraudScoringBatch(batch, env2) {
  for (const msg of batch.messages) {
    try {
      const { checkFraudBD, decideFraudRisk } = await import("./fraud_BFITCOJK.mjs");
      const { score } = await checkFraudBD(msg.body.phone, env2.FRAUDBD_API_KEY);
      const decision = decideFraudRisk(score);
      await env2.DB.prepare("UPDATE orders SET fraud_decision = ?2, updated_at = ?3 WHERE id = ?1").bind(msg.body.orderId, decision, nowSql()).run();
      msg.ack();
    } catch (err) {
...
async function enqueueD1Backup(env2, triggeredAt) {
  if (!env2.D1_BACKUP) return;
  await env2.D1_BACKUP.send({ triggeredAt });
}
async function handleD1BackupBatch(batch, env2) {
  for (const msg of batch.messages) {
    try {
      const { backupD1ToR2 } = await import("./backup_l7iqoZhn.mjs");
      await backupD1ToR2(env2.DB, env2.BACKUPS);
      await writeAuditLog(env2.DB, {
        actorStaffId: null,
        actorRole: null,
...
class VariantInventoryDO {
  ...
  async ensureInitialized(env2, variantId) {
    if (this.initialized) return;
    if (env2?.DB) {
      const row = await env2.DB.prepare("SELECT quantity, reserved_quantity FROM inventory_items WHERE variant_id = ?1").bind(variantId).first();
      if (row) {
  ...
  async fetch(request) {
    ...
    await this.ensureInitialized(env2, variantId);
    if (action === "sync") {
...
class BudgetCounterDO {
  ...
  constructor(state, env2) {
    ...
    void state.blockConcurrencyWhile(async () => {
      this.cfg = await state.storage.get("cfg") ?? null;
      this.totalUsdCents = await state.storage.get("total") ?? 0;
      this.periodStartMs = await state.storage.get("periodStartMs") ?? 0;
    });
  }
  async fetch(req) {
  ...
  status() {
    ...
    return {
      ...
      resetAt: new Date(this.periodStartMs + this.cfg.periodSeconds * 1e3).toISOString(),
  ...
  maybeRollover() {
    if (!this.cfg) return;
    if (Date.now() - this.periodStartMs >= this.cfg.periodSeconds * 1e3) {
      this.periodStartMs = Date.now();
      this.totalUsdCents = 0;
...
const DEFAULT_RULES = [
  ...
  },
  {
    ...
    expression: '(http.request.uri.path matches "^/wp-.*" or http.request.uri.path eq "/.env" or http.request.uri.path eq "/phpmyadmin" or http.request.uri.path eq "/xmlrpc.php")',
    action: "managed_challenge",
    enabled: true
  },
  {
...
class WafRules {
  ...
  constructor(state, env2) {
    ...
    this.state = {
      rules: DEFAULT_RULES,
      version: env2.WAF_RULESET_VERSION ?? "v1",
      lastRotatedAt: (/* @__PURE__ */ new Date()).toISOString().replace("T", " ").slice(0, 19)
    };
    void state.blockConcurrencyWhile(async () => {
      const stored = await state.storage.get("waf");
  ...
  async fetch(req) {
    ...
    if (req.method === "POST" && url.pathname === "/rotated") {
      ...
      this.state = { ...this.state, version: v.version ?? "v" + Math.floor(Date.now() / 1e3), lastRotatedAt: now };
...
async function routeQueue(batch, env2) {
  switch (batch.queue) {
    case "payment-webhooks":
      await handlePaymentWebhookBatch(batch, env2);
      break;
    case "order-emails":
      await handleOrderEmailBatch(batch, env2);
      break;
    case "image-processing":
      await handleImageProcessingBatch(batch);
      break;
    case "fraud-scoring":
      await handleFraudScoringBatch(batch, env2);
      break;
    case "d1-backup":
      await handleD1BackupBatch(batch, env2);
      break;
    default:
...
const entryCloudflare = {
  async fetch(request, env2, ctx) {
    const handler = server_default.fetch;
    if (!handler) throw new Error("Astro SSR handler does not export fetch");
    return handler.call(server_default, request, env2, ctx);
  },
  async scheduled(event, env2, ctx) {
    console.log(`[cron] Triggered: ${event.cron}`);
    ctx.waitUntil(dispatchCron(event.cron, env2));
  },
  async queue(batch, env2) {
    await routeQueue(batch, env2);
  }
};
const workerEntry = entryCloudflare ?? {};
export {
  BudgetCounterDO as B,
  IdempotencyDO as I,
  VariantInventoryDO as V,
  WafRules as W,
  enqueuePaymentWebhook as a,
  writeCriticalAuditLog as b,
  clientIp as c,
  reserveVariants as d,
  enqueueD1Backup as e,
  renderComponent as f,
  doSyncFromD1 as g,
  reactExports as h,
  isRemoteAllowed as i,
  workerEntry as j,
  releaseReservedVariants as r,
  spreadAttributes as s,
  trackMetric as t,
  userAgent as u,
  verifyUddoktaPayment as v,
  writeAuditLog as w
};
